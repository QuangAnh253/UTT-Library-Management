...
namespace UTT.Library.GUI.Forms.DanhMuc
{
    public partial class frmQuanLyNhaXuatBan : Form
    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (!ValidationHelper.IsRequired(txtTen, "Ten NXB")) return;
        ...
        private void dgvDanhSach_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                txtMa.Text = r.Cells["MaNhaXuatBan"].Value.ToString();
                txtTen.Text = r.Cells["TenNhaXuatBan"].Value.ToString();
        ...
        private void dgvDanhSach_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                txtMa.Text = row.Cells["MaNhaXuatBan"].Value.ToString();
                txtTen.Text = row.Cells["TenNhaXuatBan"].Value.ToString();
